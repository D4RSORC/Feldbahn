...
public class RenderWagon<T extends EntityMinecartChest> extends Render<T>{
	...
	public void doRender(T entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        IBakedModel model = Minecraft.getMinecraft().getRenderItem().getItemModelWithOverrides(entity instanceof EntityWagonBrake ? Items.WAGON_BRAKE.getDefaultInstance() : Items.WAGON.getDefaultInstance(), entity.getEntityWorld(), null);
		model = ForgeHooksClient.handleCameraTransforms(model, TransformType.GROUND, false);
		
		Minecraft.getMinecraft().getRenderItem().renderItem(entity instanceof EntityWagonBrake ? Items.WAGON_BRAKE.getDefaultInstance() : Items.WAGON.getDefaultInstance(), model);
