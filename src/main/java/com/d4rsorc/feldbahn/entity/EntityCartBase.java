...
public class EntityCartBase extends EntityRollingBase implements ILockableContainer, ILootContainer{
    ...
    public EntityRollingBase.Type getType()
    {
        return EntityRollingBase.Type.CHEST;
    }
