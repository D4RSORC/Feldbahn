...
//                }
                ...
                EntityMinecartChest entitywagon = hasBrake ? new EntityWagonBrake(worldIn, (double)pos.getX() + 0.5D, (double)pos.getY() + 0.0625D + d0, (double)pos.getZ() + 0.5D) : new EntityWagon(worldIn, (double)pos.getX() + 0.5D, (double)pos.getY() + 0.0625D + d0, (double)pos.getZ() + 0.5D);
